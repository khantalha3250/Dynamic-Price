...
def save_model(model, feature_columns, target_columns):
    ...
    """
    joblib.dump(model, "menu_price_model.pkl")
    joblib.dump(feature_columns.tolist(), "model_columns.pkl")
    joblib.dump(target_columns.tolist(), "model_target_columns.pkl")

    print("Model and column names saved.")

if __name__ == "__main__":
    dataset_file = "menu_pricing_dataset20241211_225911.csv" 
